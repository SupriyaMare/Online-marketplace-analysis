...
This repository contains a Power Bi dashboard of an Online store to answer questions about the data. The insights of the dashboard can be found in the results.txt file.  This repository can be used as a starting point for anyone who wants to learn how to use Power Bi to analyze data.
<!--Analyzed E-commerce store data. Created an interactive dashboard using Power BI.-->

## Screenshot

<img width="1495" height="839" alt="Screenshot 2026-01-13 122211" src="https://github.com/user-attachments/assets/1fa3cb17-326a-4206-86d1-8ad9de9b7c59" />
...
The project was successful in answering the set of questions about an Online Store's performance. The results of the project can be found in result.txt file.
